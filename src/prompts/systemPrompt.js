...
`;
  ...
  */
  // Use a placeholder for formattedVideos since we disabled video uploads
  const formattedVideos = 'No explanation videos provided.';
...
"HygienistReliabilityScore" Table
